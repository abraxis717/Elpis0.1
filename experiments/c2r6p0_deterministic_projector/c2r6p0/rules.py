...
def load_ruleset() -> Ruleset:
    ...
    from elpis_p0 import structural_residual as SR  # noqa: F401 (pinned)
    import structural_trm_features as F
    ...
    return Ruleset(
        ...
        structural_residual_sha=_sha(
            str(C2R7C_OVERLAY_P0 / "structural_residual.py")
        ),
        features_sha=_sha(str(C2R7C_PROBE_DIR / "structural_trm_features.py")),
        contracts_sha=_sha(str(CANON_P0_SRC / "contracts.py")),
        semantic_ir_sha=_sha(str(CANON_P0_SRC / "semantic_ir.py")),
